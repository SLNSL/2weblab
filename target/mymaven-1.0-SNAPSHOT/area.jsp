...
<div class="container">
    ...
    <div class="header">
        <h2 align="right" style="color: white; padding-right: 20px">Лаб №2 Вариант №102205</h2>
    </div>
...
<%--            <object class="graph-svg" type="image/svg+xml" data="img/graph-svg.svg" style="padding-top: 30px">--%>
...
<%--            &lt;%&ndash;            <span class="xrad"><input name="xval" type="radio" value="-3" id="x_radio_1">-3</span>&ndash;%&gt;--%>
<%--            <br>--%>
<%--            <span><b>Y:</b></span>--%>
<%--            <span class="ytext">--%>
...
<%--                   placeholder="Введите число от 2 до 5..."--%>
<%--                   style="width: 300px;">--%>
<%--            <br>--%>
<%--            &lt;%&ndash;            <button class="button" type="submit" id="submit_button">Отправить</button>&ndash;%&gt;--%>
<%--            &lt;%&ndash;            <button class="button" type="submit" id="reset_button">Очистить</button>&ndash;%&gt;--%>
...
<%--    </form>--%>
    ...
    <form style="line-height: 40px" method="get" action="/mymaven-1.0-SNAPSHOT">
<%--        <input class="hidden_goback" type="hidden" name="goback" value="">--%>
        <input class="button" type="submit" id="goback_button" value="Вернутся назад">
    </form>
