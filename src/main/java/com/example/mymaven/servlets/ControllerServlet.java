...
//        if (request.getParameter("goback")!=null && request.getParameter("goback").equals("true")){
//            System.out.println(1);
//            getServletContext().getNamedDispatcher("GoBackServlet").forward(request, response);
//        } else
